...
form.addEventListener('submit', (event) => {
    ...
    deleteBtn.className = "h-9 w-16 mx-2 text-white text-sm font-medium bg-orange-600 rounded-md shadow shadow-teal-950 hover:opacity-75";
